...
import { ChevronLeft, ChevronRight, CheckCircle2, Info, Workflow as WorkflowIcon, Sparkles } from "lucide-react";
    ...
    <div className="min-h-full bg-background text-foreground">
      ...
      <div className="relative space-y-5 overflow-hidden p-6 lg:p-8">
        ...
        <div className="relative flex items-center justify-between">
          ...
          {step < STEPS.length - 1 ? (
            <Button className="bg-amber-400 text-zinc-950 hover:bg-amber-300" onClick={() => setStep((s) => s + 1)} disabled={!canNext}>
