...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background">
      ...
      <aside
        className={cn(
          "sidebar-gradient relative flex flex-col border-r border-sidebar-border/60 text-sidebar-foreground shadow-[1px_0_0_0_color-mix(in_oklab,black_8%,transparent)] transition-[width] duration-200 ease-out",
          collapsed ? "w-16" : "w-64",
        )}
      >
        <div className={cn("flex items-center gap-2.5 border-b border-sidebar-border/60 px-4 py-4", collapsed && "justify-center px-2")}>
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/12 shadow-[0_8px_20px_-12px_rgba(0,0,0,0.35)] ring-1 ring-white/10">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-sidebar-primary to-brand text-sm font-semibold text-sidebar-primary-foreground">W</div>
          </div>
          {!collapsed && (
            ...
            <div className="pt-3">
              {!collapsed ? (
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-md px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-sidebar-foreground/45 hover:text-sidebar-foreground/80 transition-colors"
                >
        ...
        <button
          ...
          className="mx-2 mb-2 flex items-center justify-center gap-2 rounded-xl border border-sidebar-border/60 py-2.5 text-xs font-medium text-sidebar-foreground/70 transition-colors hover:bg-sidebar-accent/40 hover:text-sidebar-foreground"
        >
